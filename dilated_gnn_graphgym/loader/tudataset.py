...
def create_loader_tu(name, dataset_dir, transform, pre_transform):
    
    dataset =  TUDataset(name=name, root=dataset_dir, transform=transform, pre_transform=pre_transform,
