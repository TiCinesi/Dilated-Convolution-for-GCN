...
from dilated_gnn_graphgym.stage.dilated_stage_positional import GNNDilatedPositionalStage


@register_network('dilapos_gnn')
class DilatedPositionalGNNModel(nn.Module):
    """
    ...
    def __init__(self, dim_in, dim_out, **kwargs):
        ...
        if cfg.gnn.layers_mp > 0:
            self.mp = GNNDilatedPositionalStage(dim_in=dim_in, dim_out=cfg.gnn.dim_inner,
